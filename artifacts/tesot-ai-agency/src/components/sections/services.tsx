  ...
  return (
    <section id="servicios" className="py-12 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-7 md:mb-14 max-w-3xl">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-2.5 md:gap-5"
        >
          {capabilities.map((capability) => {
            ...
            return (
              <motion.article
                ...
                variants={item}
                className={`group relative overflow-hidden rounded-2xl border bg-card/40 p-4 md:p-8 transition-all duration-300 ${
                  isPrimary
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3 md:mb-5">
                    {capability.description}
                  </p>

                  <div
                    className={`rounded-xl border p-3 md:p-4 mb-4 md:mb-6 ${
                      isPrimary
